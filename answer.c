...
void main() {
	...
	if(strcmp(command,"NORTH")==0) {
		...
		printf("<a href=\"http://cs.mcgill.ca/~bcolli17/cgi-bin/addgold.cgi?gold=%d\">Press HERE to go NORTH</a>",goldPc);
		...
		//send user to next room
		printf("<a href=\"http://cs.mcgill.ca/~ywang498/cgi-bin/addgold.cgi?gold=%d\">Press HERE to go EAST</a>",goldPc);
